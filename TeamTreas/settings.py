"""
Django settings for TeamTreas project.
...
SECRET_KEY = 'vv=g^c*s52#d%n#%soe@wgm@d%g1wb81d4s4th_&z&+gpvif5f'
...
WSGI_APPLICATION = 'TeamTreas.wsgi.application'
